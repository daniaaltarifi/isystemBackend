...
addtop_selling = async (req, res) => {
  ...
  try {
      ...
      const query = 'INSERT INTO top_selling (product_id) VALUES (?)';
...
router.post('/add', addtop_selling);
...
const edittop_selling = async (req, res) => {
  ...
  router.put('/edit/:id', edittop_selling);
  
  

    deletetop_selling = async (req, res) => {
        const itemId = req.params.id;
            console.log(itemId);
    ...
    router.delete('/delete/:id', deletetop_selling);




    const gettop_selling = (req, res) => {
      const query = 'SELECT so.*, p.* FROM top_selling so JOIN products p ON so.product_id = p.p_id';
    ...
    router.get('/gettopselling', gettop_selling);
    

  

        const gettop_sellingByProductid  = (req, res) => {
          const itemId = req.params.id;
          console.log(itemId);
          ...
          router.get('/getspecialoffersbyproductid/:id', gettop_sellingByProductid);
          ...
          const gettop_sellingById = (req, res) => {
            const itemId =  req.params.id ;
          ...
          router.get('/getspecialoffersbyid/:id', gettop_sellingById);
